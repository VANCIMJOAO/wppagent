...
def upgrade() -> None:
    ...
    op.drop_index(
        "idx_role_permissions_permission", table_name="role_permissions", if_exists=True
    )
    op.drop_index(
    ...
    op.drop_index(
        "idx_user_roles_user_assigned", table_name="user_roles", if_exists=True
    )
    op.drop_index(
        "idx_rbac_audit_action_resource", table_name="rbac_audit_logs", if_exists=True
    )
    op.drop_index(
        "idx_rbac_audit_user_time", table_name="rbac_audit_logs", if_exists=True
    )
    op.drop_index(
        "ix_rbac_audit_logs_timestamp", table_name="rbac_audit_logs", if_exists=True
    )
    op.drop_index(
        "ix_rbac_audit_logs_user_id", table_name="rbac_audit_logs", if_exists=True
    )
    ...
    op.create_index(
        op.f("ix_appointments_date_time"), "appointments", ["date_time"], unique=False
    )
    op.create_index(
    ...
    op.drop_index(
        ...
        postgresql_where="(last_login IS NOT NULL)",
    )
    op.drop_index(
        "idx_auth_users_role_active",
        table_name="auth_users",
    ...
    op.create_index(
        op.f("ix_business_policies_id"), "business_policies", ["id"], unique=False
    )
    op.create_foreign_key(
        None, "business_policies", "businesses", ["business_id"], ["id"]
    )
    op.drop_index(
        "idx_conversations_status_last_message",
        table_name="conversations",
        postgresql_where="((status)::text = ANY ((ARRAY['active'::character varying, 'pending'::character varying])::text[]))",
    )
    ...
    op.drop_index(
        "idx_messages_conversation_count",
        table_name="messages",
        postgresql_where="((direction)::text = 'in'::text)",
    )
    ...
    op.create_foreign_key(
        None, "payment_methods", "businesses", ["business_id"], ["id"]
    )
    op.create_foreign_key(
        None, "push_subscriptions", "admin_users", ["admin_user_id"], ["id"]
    )
    op.alter_column(
        "services",
        "price",
    ...
    op.drop_constraint(
        "user_sessions_user_id_fkey", "user_sessions", type_="foreignkey"
    )
...
def downgrade() -> None:
    ...
    op.create_index(
        "idx_user_sessions_user_active",
        "user_sessions",
        ["user_id", "is_active", sa.text("expires_at DESC")],
        unique=False,
        postgresql_where="(user_id IS NOT NULL)",
    )
    op.create_index(
        "idx_user_sessions_session_id", "user_sessions", ["session_id"], unique=False
    )
    op.create_index(
        "idx_user_sessions_expired",
        "user_sessions",
    ...
    op.create_index(
        ...
        "payment_methods",
        ["business_id", "is_active", "display_order"],
        unique=False,
    )
    op.alter_column(
        "payment_methods",
    ...
    op.create_index(
        "messages_conv_dir_created",
        "messages",
        ["conversation_id", "direction", "created_at"],
        unique=False,
    )
    op.create_index(
        "idx_messages_user_created", "messages", ["user_id", "created_at"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        ...
        "business_policies",
        ["business_id", "policy_type", "is_active"],
        unique=False,
    )
    op.create_index(
        "idx_business_policies_business_type",
        "business_policies",
        ["business_id", "policy_type", "is_active"],
        unique=False,
    )
    ...
    op.create_index(
        "idx_appointments_user_status_date",
        "appointments",
        ["user_id", "status", sa.text("date_time DESC")],
        unique=False,
    )
    op.create_index(
    ...
    op.create_index(
        "idx_appointments_date_time", "appointments", ["date_time"], unique=False
    )
    op.create_index(
        "idx_appointments_business_datetime",
        "appointments",
        ["business_id", sa.text("date_time DESC")],
        unique=False,
    )
    op.create_table(
        "rbac_users",
        sa.Column(
            "id",
            sa.INTEGER(),
            server_default=sa.text("nextval('rbac_users_id_seq'::regclass)"),
            autoincrement=True,
            nullable=False,
        ),
        sa.Column(
        ...
        sa.UniqueConstraint(
            "email",
            name="rbac_users_email_key",
            postgresql_include=[],
            postgresql_nulls_not_distinct=False,
        ),
        sa.UniqueConstraint(
            "username",
            name="rbac_users_username_key",
            postgresql_include=[],
            postgresql_nulls_not_distinct=False,
        ),
    ...
    op.create_index(
        "idx_user_roles_user_assigned",
        "user_roles",
        ["user_id", sa.text("assigned_at DESC")],
        unique=False,
    )
    op.create_index(
    ...
    op.create_table(
        ...
        sa.Column(
            "token_hash", sa.VARCHAR(length=255), autoincrement=False, nullable=True
        ),
    ...
    op.create_table(
        ...
        sa.Column(
            "id",
            sa.INTEGER(),
            server_default=sa.text("nextval('rbac_permissions_id_seq'::regclass)"),
            autoincrement=True,
            nullable=False,
        ),
        sa.Column(
        ...
        sa.UniqueConstraint(
            "permission_type",
            name="rbac_permissions_permission_type_key",
            postgresql_include=[],
            postgresql_nulls_not_distinct=False,
        ),
        postgresql_ignore_search_path=False,
    ...
    op.create_table(
        ...
        sa.Column(
            "resource_id", sa.VARCHAR(length=100), autoincrement=False, nullable=True
        ),
        sa.Column(
            "details",
            postgresql.JSON(astext_type=sa.Text()),
        ...
        sa.ForeignKeyConstraint(
            ["user_id"],
            ["rbac_users.id"],
            name="rbac_audit_logs_user_id_fkey",
            ondelete="SET NULL",
        ),
        sa.PrimaryKeyConstraint("id", name="rbac_audit_logs_pkey"),
    )
    op.create_index(
        "ix_rbac_audit_logs_user_id", "rbac_audit_logs", ["user_id"], unique=False
    )
    op.create_index(
        "ix_rbac_audit_logs_timestamp", "rbac_audit_logs", ["timestamp"], unique=False
    )
    op.create_index(
    ...
    op.create_index(
        ...
        "rbac_audit_logs",
        ["action", "resource_type", sa.text("timestamp DESC")],
        unique=False,
    )
    op.create_table(
        "rbac_roles",
    ...
    op.create_table(
        ...
        sa.Column("id", sa.INTEGER(), autoincrement=False, nullable=True),
        sa.Column(
            "session_token", sa.VARCHAR(length=255), autoincrement=False, nullable=True
        ),
        sa.Column("admin_user_id", sa.INTEGER(), autoincrement=False, nullable=True),
        sa.Column(
            "ip_address", sa.VARCHAR(length=45), autoincrement=False, nullable=True
    ...
    op.create_index(
        "idx_role_permissions_role_assigned",
        "role_permissions",
        ["role_id", sa.text("assigned_at DESC")],
        unique=False,
    )
    op.create_index(
        "idx_role_permissions_permission",
        "role_permissions",
        ["permission_id", sa.text("assigned_at DESC")],
        unique=False,
    )
    op.create_table(
        ...
        sa.Column(
            "attempted_at", postgresql.TIMESTAMP(), autoincrement=False, nullable=True
        ),
        sa.Column("error_message", sa.TEXT(), autoincrement=False, nullable=True),
        sa.Column(
            "backup_created_at",
