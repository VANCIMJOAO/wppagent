...
def upgrade():
    ...
    permission_type_enum = postgresql.ENUM(
        ...
        'appointments:view', 'appointments:create', 'appointments:update', 'appointments:delete', 'appointments:admin',
        'conversations:view', 'conversations:respond', 'conversations:delete', 'conversations:admin',
        'clients:view', 'clients:create', 'clients:update', 'clients:delete', 'clients:admin',
        'reports:view', 'reports:export', 'reports:admin',
        'system:admin', 'users:manage', 'roles:manage', 'permissions:manage',
        'monitoring:view', 'monitoring:admin',
        'backup:create', 'backup:restore', 'backup:admin',
        name='permissiontype'
    )
    ...
    role_type_enum = postgresql.ENUM(
        'super_admin', 'admin', 'manager', 'operator', 'viewer', 'guest',
        name='roletype'
    )
    ...
    op.create_table('user_roles',
        sa.Column('user_id', sa.Integer(), sa.ForeignKey('rbac_users.id'), nullable=False),
    ...
    op.create_table('role_permissions',
        sa.Column('role_id', sa.Integer(), sa.ForeignKey('rbac_roles.id'), nullable=False),
        sa.Column('permission_id', sa.Integer(), sa.ForeignKey('rbac_permissions.id'), nullable=False),
    ...
    op.create_index('idx_rbac_permissions_type', 'rbac_permissions', ['permission_type'])
