...
def upgrade():
    ...
    op.execute("""
        CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_appointments_business_datetime
    ...
    op.execute("""
        CREATE INDEX CONCURRENTLY IF NOT EXISTS idx_users_telefone
        ON users(telefone)
    """)
    ...
    op.execute("""
        ...
        ON services(business_id, ativo) WHERE ativo = true
    """)
