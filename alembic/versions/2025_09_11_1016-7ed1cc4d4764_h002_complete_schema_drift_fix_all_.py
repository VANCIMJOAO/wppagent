...
def upgrade() -> None:
    ...
    try:
        # Remove old indexes
        op.drop_index(
            "idx_appointments_date_time", table_name="appointments", if_exists=True
        )
        op.drop_index(
        ...
        op.drop_index(
            "idx_appointments_price", table_name="appointments", if_exists=True
        )
        op.drop_index(
            "idx_appointments_status", table_name="appointments", if_exists=True
        )
        op.drop_index(
            "idx_appointments_user_date", table_name="appointments", if_exists=True
        )
    ...
    try:
        ...
        op.drop_constraint(
            "auth_users_email_key", "auth_users", type_="unique", if_exists=True
        )
        op.drop_index(
            "idx_auth_users_email_active", table_name="auth_users", if_exists=True
        )
        op.drop_index(
            "idx_auth_users_last_login", table_name="auth_users", if_exists=True
        )
    ...
    try:
        ...
        op.execute(
            "UPDATE business_hours SET open_time = CAST(open_time AS TEXT) WHERE open_time IS NOT NULL"
        )
        op.execute(
            "UPDATE business_hours SET close_time = CAST(close_time AS TEXT) WHERE close_time IS NOT NULL"
        )
        op.execute(
            "UPDATE business_hours SET break_start_time = CAST(break_start_time AS TEXT) WHERE break_start_time IS NOT NULL"
        )
        op.execute(
            "UPDATE business_hours SET break_end_time = CAST(break_end_time AS TEXT) WHERE break_end_time IS NOT NULL"
        )
    ...
    try:
        ...
        try:
            op.create_foreign_key(
                "fk_business_policies_business_id",
                "business_policies",
                "businesses",
                ["business_id"],
                ["id"],
    ...
    try:
        ...
        op.alter_column(
            "login_attempts", "attempted_at", type_=sa.DateTime(timezone=True)
        )
        ...
        op.drop_index(
            "idx_login_attempts_email", table_name="login_attempts", if_exists=True
        )
        op.drop_index(
            "idx_login_attempts_email_time", table_name="login_attempts", if_exists=True
        )
        op.drop_index(
        ...
        op.drop_index(
            "idx_login_attempts_ip_time", table_name="login_attempts", if_exists=True
        )
    ...
    try:
        op.drop_index(
            "idx_messages_user_created", table_name="messages", if_exists=True
        )
    except Exception as e:
    ...
    try:
        ...
        op.drop_index(
            "idx_payment_methods_business", table_name="payment_methods", if_exists=True
        )
        ...
        try:
            op.create_foreign_key(
                "fk_payment_methods_business_id",
                "payment_methods",
                "businesses",
                ["business_id"],
                ["id"],
    ...
    try:
        ...
        # Remove old indexes and constraints
        op.drop_index(
            "idx_user_sessions_expired", table_name="user_sessions", if_exists=True
        )
        op.drop_index(
            "idx_user_sessions_session_id", table_name="user_sessions", if_exists=True
        )
        op.drop_index(
            "idx_user_sessions_user_active", table_name="user_sessions", if_exists=True
        )
        op.drop_index(
            "idx_user_sessions_user_id", table_name="user_sessions", if_exists=True
        )
        op.drop_constraint(
