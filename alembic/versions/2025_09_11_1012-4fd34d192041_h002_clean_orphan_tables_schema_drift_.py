...
def upgrade() -> None:
    ...
    try:
        ...
        op.execute("ALTER TABLE auth_users ALTER COLUMN created_at TYPE TIMESTAMP WITH TIME ZONE")
        op.execute("ALTER TABLE auth_users ALTER COLUMN updated_at TYPE TIMESTAMP WITH TIME ZONE")
        op.execute("ALTER TABLE auth_users ALTER COLUMN last_login TYPE TIMESTAMP WITH TIME ZONE")
    ...
    try:
        ...
        op.execute("ALTER TABLE business_hours ALTER COLUMN break_start_time TYPE VARCHAR(5)")
        op.execute("ALTER TABLE business_hours ALTER COLUMN break_end_time TYPE VARCHAR(5)")
    ...
    try:
        # login_attempts
        op.execute("ALTER TABLE login_attempts ALTER COLUMN ip_address TYPE VARCHAR(45)")
        op.execute("ALTER TABLE login_attempts ALTER COLUMN attempted_at TYPE TIMESTAMP WITH TIME ZONE")
    ...
    try:
        # user_sessions
        op.execute("ALTER TABLE user_sessions ALTER COLUMN created_at TYPE TIMESTAMP WITH TIME ZONE")
        op.execute("ALTER TABLE user_sessions ALTER COLUMN expires_at TYPE TIMESTAMP WITH TIME ZONE")
