...
def upgrade() -> None:
    ...
    try:
        op.drop_index(
            op.f("idx_business_policies_business_type"),
    ...
    try:
        op.drop_index(
            op.f("idx_payment_methods_business"),
    ...
    try:
        op.drop_index(
            op.f("idx_business_hours_business_day"),
...
def downgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "break_start_time", postgresql.TIME(), autoincrement=False, nullable=True
        ),
        sa.Column(
            "break_end_time", postgresql.TIME(), autoincrement=False, nullable=True
        ),
        ...
        sa.CheckConstraint(
            ...
            name=op.f("business_hours_day_of_week_check"),
        ),
        sa.ForeignKeyConstraint(
            ["business_id"],
            ["businesses.id"],
            name=op.f("business_hours_business_id_fkey"),
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["business_id"],
            ["businesses.id"],
            name=op.f("payment_methods_business_id_fkey"),
        ),
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["business_id"],
            ["businesses.id"],
            name=op.f("business_policies_business_id_fkey"),
        ),
