...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column(
            "role_type", sa.Enum("SYSTEM", "CUSTOM", name="roletype"), nullable=True
        ),
    ...
    op.create_index(
        op.f("ix_rbac_permissions_permission_type"),
        "rbac_permissions",
        ["permission_type"],
        unique=True,
    )
    ...
    op.create_index(
        op.f("ix_rbac_users_username"), "rbac_users", ["username"], unique=True
    )
    ...
    op.create_table(
        ...
        sa.ForeignKeyConstraint(
            ["assigned_by"], ["rbac_users.id"], ondelete="SET NULL"
        ),
    ...
    op.create_index(
        op.f("ix_rbac_audit_logs_timestamp"), "rbac_audit_logs", ["timestamp"]
    )
