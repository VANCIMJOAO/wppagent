...
def upgrade() -> None:
    ...
    op.create_table('push_subscriptions',
        ...
        sa.Column('admin_user_id', sa.Integer(), sa.ForeignKey('admin_users.id'), nullable=False, index=True),
    ...
    op.create_table('push_notifications',
        ...
        sa.Column('subscription_id', sa.Integer(), sa.ForeignKey('push_subscriptions.id'), nullable=False),
