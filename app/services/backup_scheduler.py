...
class BackupScheduler:
    ...
    def __init__(self):
        ...
        self.backup_schedule = os.getenv("BACKUP_SCHEDULE", "0 2 * * *")  # 2h da manhã diariamente
        self.health_check_interval = int(os.getenv("BACKUP_HEALTH_CHECK_INTERVAL", "6"))  # 6 horas
            ...
            if backup_dir.exists():
                ...
                if total_size_gb > 10:  # Mais de 10GB
                    await alert_manager.create_alert(
                        ...
                        data={"disk_usage_gb": total_size_gb, "total_backups": status.get("total_backups")}
                    )
    ...
    def _has_recent_failures(self) -> bool:
        ...
        failures = [exec for exec in recent_executions if not exec.get("success", False)]
