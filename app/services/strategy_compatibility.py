...
from .strategy_manager import StrategyResponse, strategy_manager
...
class CompatibilityAdapter:
    ...
    def _convert_new_to_old_format(
        self, new_response: StrategyResponse
    ) -> Dict[str, Any]:
        ...
        return {
            ...
            "agent_used": new_response.metadata.get(
                "agent_role", new_response.strategy_used
            ),
            ...
            "metadata": {
                **(new_response.metadata or {}),
                ...
                "selection_reason": new_response.metadata.get(
