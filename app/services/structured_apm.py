...
class StructuredLogger:
    ...
    def debug(
        ...
        log_entry = self._create_log_entry(
            LogLevel.DEBUG.value, message, category, metadata
        )
    ...
    def info(
        ...
        log_entry = self._create_log_entry(
            LogLevel.INFO.value, message, category, metadata
        )
    ...
    def warning(
        ...
        log_entry = self._create_log_entry(
            LogLevel.WARNING.value, message, category, metadata
        )
    ...
    def error(
        ...
        log_entry = self._create_log_entry(
            LogLevel.ERROR.value, message, category, metadata, exception
        )
    ...
    def critical(
        ...
        log_entry = self._create_log_entry(
            LogLevel.CRITICAL.value, message, category, metadata, exception
        )
        ...
        async def async_wrapper(*args, **kwargs):
            ...
            try:
                ...
                metrics = PerformanceMetrics(
                    operation_name=name, duration_ms=duration_ms
                )
