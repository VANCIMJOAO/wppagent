...
class LGPDRetentionScheduler:
    ...
    def _run_daily_retention(self):
        ...
        try:
            ...
            result = loop.run_until_complete(self.lgpd_manager.apply_retention_policies())
            
            logger.info(f"✅ Retenção diária concluída: {result['total_records_processed']} registros processados")
            ...
            if result['total_records_anonymized'] > 0:
                logger.info(f"🔒 Registros anonimizados: {result['total_records_anonymized']}")
    ...
    def _run_weekly_deep_cleanup(self):
        ...
        try:
            ...
            logger.info(f"✅ Limpeza semanal concluída: {result['total_records_processed']} registros")
    ...
    def _run_monthly_audit(self):
        ...
        try:
            ...
            report = loop.run_until_complete(self.lgpd_manager.get_data_processing_report())
    ...
    def _cleanup_old_exports(self):
        ...
        try:
            ...
            if deleted_count > 0:
                logger.info(f"🧹 {deleted_count} arquivos de exportação antigos removidos")
    ...
    def _save_monthly_report(self, report: Dict[str, Any]):
        ...
        try:
            ...
            report_file = reports_dir / f"lgpd_audit_{datetime.utcnow().strftime('%Y%m')}.json"
