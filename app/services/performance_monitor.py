...
class SystemPerformanceMonitor:
    ...
    async def collect_system_metrics(self) -> Dict[str, PerformanceMetric]:
        ...
        try:
            ...
            performance_logger.error(
                f"Error collecting system metrics: {e}", exc_info=True
            )
            return {}
    ...
    async def check_database_performance(self) -> Dict[str, PerformanceMetric]:
        ...
        try:
            ...
            performance_logger.error(
                f"Error checking database performance: {e}", exc_info=True
            )
            return {}
    ...
    async def check_api_performance(self) -> Dict[str, PerformanceMetric]:
        ...
        try:
            ...
            performance_logger.error(
                f"Error checking API performance: {e}", exc_info=True
            )
            return {}
    ...
    async def check_external_services(self) -> Dict[str, PerformanceMetric]:
        ...
        try:
            ...
            performance_logger.error(
                f"Error checking external services: {e}", exc_info=True
            )
            return {}
                ...
                if threshold_key in self.thresholds:
                    ...
                    # Resolver alerta se voltou ao normal
                        ...
                        await alert_manager.resolve_alert(
                            f"performance_critical_{metric.name}"
                        )
                        await alert_manager.resolve_alert(
                            f"performance_warning_{metric.name}"
                        )
    ...
    async def get_performance_summary(self) -> Dict[str, Any]:
        ...
        try:
            ...
            performance_logger.error(
                f"Error generating performance summary: {e}", exc_info=True
            )
            return {}
