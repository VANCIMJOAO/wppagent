...
class ProductionAlertManager:
    ...
    def _setup_channels(self):
        ...
        try:
            ...
            if (
                hasattr(settings, "alert_email_enabled")
                ...
                email_channel = EmailAlertChannel(
                    ...
                    from_email=getattr(
                        settings, "alert_from_email", "alerts@whatsapp-agent.com"
                    ),
            ...
            if (
                hasattr(settings, "alert_whatsapp_phone")
                and settings.alert_whatsapp_phone
            ):
    ...
    def add_alert(
        self, alert_id: str, message: str, severity: str, metadata: dict = None
    ):
    ...
    async def alert_high_error_rate(
        self, component: str, error_rate: float, threshold: float
    ):
    ...
    async def alert_slow_response(
        self, component: str, response_time: float, threshold: float
    ):
    ...
    async def alert_low_conversion_rate(
        self, current_rate: float, expected_rate: float
    ):
    ...
    async def alert_security_threat(
        self, threat_type: str, source_ip: str, details: Dict[str, Any]
    ):
...
async def alert_critical(
    title: str, message: str, metadata: Optional[Dict[str, Any]] = None
):
