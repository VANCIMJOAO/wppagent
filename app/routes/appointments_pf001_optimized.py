...
from app.models.database import Appointment, User, Business, Service, Conversation
...
router = APIRouter(prefix="/appointments/optimized", tags=["Appointments Optimized - PF001"])
        ...
        try:
            ...
            for appointment in appointments_orm:
                ...
                appointment_dict = {
                    ...
                    "conversation_count": len(appointment.conversations) if appointment.conversations else 0
                }
