...
async def export_appointments(
    format: Literal['csv', 'excel', 'pdf'] = Query(default='excel', description="Formato do relatório"),
...
async def export_dashboard(
    format: Literal['excel', 'pdf', 'csv'] = Query(default='excel', description="Formato do relatório"),
    ...
    return {
        "formats": {
            ...
            "excel": {
                ...
                "extension": "xlsx",
                "features": ["formatação_avançada", "múltiplas_abas", "gráficos", "resumo_executivo"]
            },
            "pdf": {
                "name": "PDF",
                ...
                "extension": "pdf",
                "features": ["layout_profissional", "tabelas_formatadas", "resumo_visual", "impressão"]
            }
        },
        "report_types": {
            "appointments": {
