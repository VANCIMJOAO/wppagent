...
from app.services.alert_system import alert_manager, AlertSeverity, AlertType
...
async def create_test_alert(current_user = Depends(get_current_admin_user)):
    ...
    try:
        ...
        raise HTTPException(status_code=500, detail=f"Erro ao criar alerta de teste: {str(e)}")
