    ...
    try:
        ...
        logger.info(
            ...
            metadata={
                ...
                "success_rate": (
                    total_processed / (total_processed + total_blocked)
                    if (total_processed + total_blocked) > 0
                    else 1.0
                ),
    ...
    try:
        ...
        log_business_event(
            ...
            metadata={
                ...
                "is_new_user": user.created_at.timestamp()
                > (datetime.utcnow().timestamp() - 300),  # 5 min
            },
        )
        ...
        logger.error(
            ...
            metadata={
                ...
                "message_preview": (
                    clean_content[:50] if "clean_content" in locals() else "unknown"
                ),
                "error_type": e.__class__.__name__,
            },
            category=LogCategory.WEBHOOK,
...
async def verify_webhook(
    ...
    if hub_mode == "subscribe" and hub_verify_token == expected_token:
        ...
        log_security_event(
            ...
            {"hub_mode": hub_mode, "timestamp": datetime.utcnow().isoformat()},
            severity="INFO",
        )
...
async def get_webhook_stats():
    ...
    try:
        ...
        raise HTTPException(
            status_code=500, detail="Erro interno ao obter estatísticas"
        )
...
async def clear_webhook_cache():
    ...
    try:
        ...
        logger.warning(
            ...
            metadata={"cache_clear_result": result, "admin_action": "cache_clear"},
            category=LogCategory.SECURITY,
        )
