...
class AppointmentBase(BaseModel):
    ...
    date_time: datetime = Field(
        serialization_alias="dateTime", description="Data e hora do agendamento"
    )
    duration_minutes: int = Field(
        default=60, ge=15, le=480, serialization_alias="durationMinutes"
    )  # 15min a 8h
    ...
    @field_serializer("date_time", "created_at", "updated_at", when_used="json")
...
class AppointmentUpdate(BaseModel):
    ...
    duration_minutes: Optional[int] = Field(
        None, ge=15, le=480, serialization_alias="durationMinutes"
    )
