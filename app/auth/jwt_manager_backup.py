...
class JWTManager:
    ...
    def create_access_token(
        self, user_id: str, role: str = "user", permissions: list = None
    ) -> str:
        ...
        expire_time = (
            self.admin_token_expire if role == "admin" else self.access_token_expire
        )
        ...
        try:
            ...
            try:
                ...
                if self.redis_available and self.redis_client:
                    ...
                    if previous_secret:
                        payload = jwt.decode(
                            token, previous_secret.decode(), algorithms=[self.algorithm]
                        )
                        return payload
                    else:
    ...
    def refresh_access_token(self, refresh_token: str) -> Tuple[str, str]:
        ...
        try:
            ...
            new_access_token = self.create_access_token(
                user_id, user_info.get("role", "user"), user_info.get("permissions", [])
            )
