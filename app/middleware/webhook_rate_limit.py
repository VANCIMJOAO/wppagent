...
from app.config.redis_config import redis_manager, execute_redis_safe_async
...
class WebhookRateLimitMiddleware(BaseHTTPMiddleware):
    ...
    def __init__(self, app):
        ...
        logger.info(f"H003 WebhookRateLimitMiddleware initialized - {self.config.requests_per_minute} req/min per IP")
    ...
    async def _log_rate_limit_block(self, client_ip: str, rate_info: Dict, request: Request):
    ...
    async def get_rate_limit_stats(self, client_ip: str) -> Dict:
        ...
        async def _get_stats():
            ...
            return {
                ...
                "remaining_requests": max(0, self.config.requests_per_minute - minute_count),
